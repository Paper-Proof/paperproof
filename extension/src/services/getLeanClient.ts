...
const getLeanClient = async (shared: Shared) => {
  ...
  try {
    ...
    const errorMessage = `
      ...
      , type <span style="color: #4791b8;">"Extensions: Install Specific Version of Extension..."</span>, and change your <b>lean4 vscode extension</b> to one of these versions: <b>v0.0.176</b>, <b>v0.0.144</b>.<br/>
